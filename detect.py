...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / 'test_multiple', help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--data', type=str, default=ROOT / 'my_data/data.yaml', help='(optional) dataset.yaml path')
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[640], help='inference size h,w')
    parser.add_argument('--conf-thres', type=float, default=0.15, help='confidence threshold')         #置信度
    parser.add_argument('--iou-thres', type=float, default=0.47, help='NMS IoU threshold')
